...
//		driver.findElement(By.xpath("//div[text()='round trip']")).click();
		...
		driver.findElement(By.xpath("//div[@data-testid='to-testID-origin']/descendant::input[@autocapitalize='sentences']")).sendKeys("bang");
		driver.findElement(By.xpath("//div[text()='To']")).click();
		driver.findElement(By.xpath("//div[@data-testid='to-testID-destination']/descendant::input[@autocapitalize='sentences']")).sendKeys("goa");
		...
		driver.findElement(By.xpath("//div[contains(text(),'27')]/ancestor::div[@data-testid='undefined-month-February-2023']/descendant::div[@data-testid='undefined-calendar-day-27']")).click();
		...
		driver.findElement(By.xpath("//input[@data-testid='first-inputbox-contact-details']")).sendKeys("sarfraj");
		driver.findElement(By.xpath("//input[@data-testid='last-inputbox-contact-details']")).sendKeys("ahmad");
		driver.findElement(By.xpath("//input[@data-testid='contact-number-input-box']")).sendKeys("7004898612");
		driver.findElement(By.xpath("//input[@data-testid='emailAddress-inputbox-contact-details']")).sendKeys("sonuking8381@gmail.com");
		driver.findElement(By.xpath("//input[@data-testid='city-inputbox-contact-details']")).sendKeys("bangalore");
		
		//first passenger
//		driver.findElement(By.xpath("//input[@data-testid='traveller-0-first-traveller-info-input-box']")).sendKeys(name);
//		driver.findElement(By.xpath("//input[@data-testid='traveller-0-last-traveller-info-input-box']")).sendKeys(sname);
...
//		
//		//second passenger
//		driver.findElement(By.xpath("//input[@data-testid='traveller-1-first-traveller-info-input-box']")).sendKeys(name);
//		driver.findElement(By.xpath("//input[@data-testid='traveller-1-last-traveller-info-input-box']")).sendKeys(sname);
//		driver.findElement(By.xpath("//input[@data-testid='sc-member-mobile-number-input-box']")).sendKeys(mobile);
//		try
//		{
//			driver.findElement(By.xpath("//div[text()='Student ID Card*']/ancestor::div[@class='css-1dbjc4n r-18u37iz r-1w6e6rj r-xzortm']/descendant::input[@class='css-1cwyjr8 r-homxoj r-poiln3 r-ubezar r-1eimq0t r-1e081e0 r-xfkzu9 r-lnhwgy']")).sendKeys(sid);
...
//		
//		//third passenger
//		driver.findElement(By.xpath("//input[@data-testid='traveller-2-first-traveller-info-input-box']")).sendKeys(name);
//		driver.findElement(By.xpath("//input[@data-testid='traveller-2-last-traveller-info-input-box']")).sendKeys(sname);
//		driver.findElement(By.xpath("//input[@data-testid='sc-member-mobile-number-input-box']")).sendKeys(mobile);
//		try
//		{
//			driver.findElement(By.xpath("//div[text()='Student ID Card*']/ancestor::div[@class='css-1dbjc4n r-18u37iz r-1w6e6rj r-xzortm']/descendant::input[@class='css-1cwyjr8 r-homxoj r-poiln3 r-ubezar r-1eimq0t r-1e081e0 r-xfkzu9 r-lnhwgy']")).sendKeys(sid);
...
//		
//		//fourth passenger
//		driver.findElement(By.xpath("//input[@data-testid='traveller-3-first-traveller-info-input-box']")).sendKeys(name);
//		driver.findElement(By.xpath("//input[@data-testid='traveller-3-last-traveller-info-input-box']")).sendKeys(sname);
//		driver.findElement(By.xpath("//input[@data-testid='sc-member-mobile-number-input-box']")).sendKeys(mobile);
//		try
//		{
//			driver.findElement(By.xpath("//div[text()='Student ID Card*']/ancestor::div[@class='css-1dbjc4n r-18u37iz r-1w6e6rj r-xzortm']/descendant::input[@class='css-1cwyjr8 r-homxoj r-poiln3 r-ubezar r-1eimq0t r-1e081e0 r-xfkzu9 r-lnhwgy']")).sendKeys(sid);
